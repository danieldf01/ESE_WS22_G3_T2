...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_LSANFANGBISHS_QUITTIERTVERSCHWUNDENLSABISHS1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_LSANFANGBISHS_QUITTIERTVERSCHWUNDENLSABISHS1_H_

#include "BaseStateLSAbisHS1.h"
#include "WartenLSAbisHS1.h"
#include "WsAufWegZumHsLSAbisHS1.h"

class QuittiertVerschwundenLSAbisHS1 : public BaseStateLSAbisHS1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_LSANFANGBISHS_QUITTIERTVERSCHWUNDENLSABISHS1_H_ */
