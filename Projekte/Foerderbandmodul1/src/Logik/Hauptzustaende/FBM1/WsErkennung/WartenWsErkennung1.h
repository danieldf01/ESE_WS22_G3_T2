/*
 * WartenWsErkennung1.h
 *
 *  Created on: 15.12.2022
 *      Author: Daniel Drefs Fernandes
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_WSERKENNUNG_WARTENWSERKENNUNG1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_WSERKENNUNG_WARTENWSERKENNUNG1_H_

#include "BaseStateWsErkennung1.h"
#include "WarteMessungWsErkennung1.h"

class WartenWsErkennung1 : public BaseStateWsErkennung1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_WSERKENNUNG_WARTENWSERKENNUNG1_H_ */
