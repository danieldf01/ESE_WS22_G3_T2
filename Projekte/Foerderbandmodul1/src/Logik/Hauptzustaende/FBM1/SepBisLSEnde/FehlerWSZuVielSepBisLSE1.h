...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_FEHLERWSZUVIELSEPBISLSE1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_FEHLERWSZUVIELSEPBISLSE1_H_

#include "BaseStateSepBisLSE1.h"
#include "QuittiertZuVielSepBisLSE1.h"

class FehlerWSZuVielSepBisLSE1 : public BaseStateSepBisLSE1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_FEHLERWSZUVIELSEPBISLSE1_H_ */
