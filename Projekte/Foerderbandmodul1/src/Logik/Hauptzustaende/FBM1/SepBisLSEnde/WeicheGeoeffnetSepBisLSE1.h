...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_WEICHEGEOEFFNETSEPBISLSE1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_WEICHEGEOEFFNETSEPBISLSE1_H_

#include "BaseStateSepBisLSE1.h"
#include "WsAufWegZuLSEndeSepBisLSE1.h"

class WeicheGeoeffnetSepBisLSE1 : public BaseStateSepBisLSE1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_SEPBISLSENDE_WEICHEGEOEFFNETSEPBISLSE1_H_ */
