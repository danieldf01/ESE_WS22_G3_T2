...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_ACTIONSHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_ACTIONSHSBISSEP1_H_
...
class ActionsHSBisSep1 {
protected:
	int logikID;
	WsListen *wsListen;
	Zeitmanager *zeitmanager;
public:
	virtual ~ActionsHSBisSep1();
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_ACTIONSHSBISSEP1_H_ */
