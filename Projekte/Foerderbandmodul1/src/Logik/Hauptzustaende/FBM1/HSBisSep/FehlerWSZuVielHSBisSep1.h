/*
 * FehlerWSZuVielHSBisSep1.h
 *
 *  Created on: 17.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUVIELHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUVIELHSBISSEP1_H_

#include "BaseStateHSBisSep1.h"
#include "QuittiertZuVielHSBisSep1.h"

class FehlerWSZuVielHSBisSep1 : public BaseStateHSBisSep1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUVIELHSBISSEP1_H_ */
