...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP1_H_

#include "BaseStateHSBisSep1.h"
#include "QuittiertZuFruehHSBisSep1.h"

class FehlerWsZuFruehHSBisSep1 : public BaseStateHSBisSep1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP1_H_ */
