...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTENHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTENHSBISSEP1_H_

#include "BaseStateHSBisSep1.h"
#include "FehlerWSZuVielHSBisSep1.h"
#include "WSAufWegZumSep1.h"

class WartenHSBisSep1: public BaseStateHSBisSep1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTENHSBISSEP1_H_ */
