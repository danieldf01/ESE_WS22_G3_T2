/*
 * FehlerWsVerschwundenHSBisSep1.h
 *
 *  Created on: 17.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSVERSCHWUNDENHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSVERSCHWUNDENHSBISSEP1_H_

#include "BaseStateHSBisSep1.h"
#include "QuittiertVerschwundenHSBisSep1.h"
#include "WartenHSBisSep1.h"

class FehlerWsVerschwundenHSBisSep1 : public BaseStateHSBisSep1{
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_FEHLERWSVERSCHWUNDENHSBISSEP1_H_ */
