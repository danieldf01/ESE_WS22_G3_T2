...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WSAUFWEGZUMSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WSAUFWEGZUMSEP1_H_
...
class WSAufWegZumSep1 : public BaseStateHSBisSep1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WSAUFWEGZUMSEP1_H_ */
