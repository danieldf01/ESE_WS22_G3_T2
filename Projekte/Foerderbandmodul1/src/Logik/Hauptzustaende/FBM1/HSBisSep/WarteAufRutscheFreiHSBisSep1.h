/*
 * FehlerNichtAussortierbarHSBisSep1.h
 *
 *  Created on: 19.12.2022
 *      Author: Daniel Drefs Fernandes
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTEAUFRUTSCHEFREIHSBISSEP1_H_
#define LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTEAUFRUTSCHEFREIHSBISSEP1_H_

#include "BaseStateHSBisSep1.h"
#include "WartenHSBisSep1.h"

class WarteAufRutscheFreiHSBisSep1 : public BaseStateHSBisSep1 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM1_HSBISSEP_WARTEAUFRUTSCHEFREIHSBISSEP1_H_ */
