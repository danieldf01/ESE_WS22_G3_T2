/*
 * FehlerWsZuFruehHSBisSep1.h
 *
 *  Created on: 17.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP2_H_

#include "BaseStateHSBisSep2.h"
#include "QuittiertZuFruehHSBisSep2.h"

class FehlerWsZuFruehHSBisSep2 : public BaseStateHSBisSep2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_FEHLERWSZUFRUEHHSBISSEP2_H_ */
