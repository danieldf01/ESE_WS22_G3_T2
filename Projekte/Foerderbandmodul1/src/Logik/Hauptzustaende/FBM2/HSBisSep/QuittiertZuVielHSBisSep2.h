/*
 * QuittiertZuVielHSBisSep2.h
 *
 *  Created on: 17.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTZUVIELHSBISSEP2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTZUVIELHSBISSEP2_H_

#include "BaseStateHSBisSep2.h"
#include "WartenHSBisSep2.h"
#include "WSAufWegZumSep2.h"

class QuittiertZuVielHSBisSep2 : public BaseStateHSBisSep2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTZUVIELHSBISSEP2_H_ */
