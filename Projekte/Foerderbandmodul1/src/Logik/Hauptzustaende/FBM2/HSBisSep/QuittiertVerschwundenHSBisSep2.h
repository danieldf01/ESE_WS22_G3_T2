/*
 * QuittiertVerschwundenHSBisSep2.h
 *
 *  Created on: 19.12.2022
 *      Author: Daniel Drefs Fernandes
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTVERSCHWUNDENHSBISSEP2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTVERSCHWUNDENHSBISSEP2_H_

#include "BaseStateHSBisSep2.h"
#include "WartenHSBisSep2.h"

class QuittiertVerschwundenHSBisSep2 : public BaseStateHSBisSep2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_HSBISSEP_QUITTIERTVERSCHWUNDENHSBISSEP2_H_ */
