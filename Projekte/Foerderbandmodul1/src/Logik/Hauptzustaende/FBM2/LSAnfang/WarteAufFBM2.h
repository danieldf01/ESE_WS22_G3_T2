...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_WARTEAUFFBM2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_WARTEAUFFBM2_H_

#include "BaseStateLSA2.h"
#include "FehlerWSZuVielLSA2.h"
#include "WarteWSVerlaesstFBM1.h"

class WarteAufFBM2 : public BaseStateLSA2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_WARTEAUFFBM2_H_ */
