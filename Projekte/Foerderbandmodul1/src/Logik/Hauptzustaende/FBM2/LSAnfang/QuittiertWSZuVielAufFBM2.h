/*
 * QuittiertWSZuVielAufFBM2.h
 *
 *  Created on: 22.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_QUITTIERTWSZUVIELAUFFBM2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_QUITTIERTWSZUVIELAUFFBM2_H_

#include "BaseStateLSA2.h"
#include "WarteFBM2Frei.h"
#include "WarteAufFBM2.h"

class QuittiertWSZuVielAufFBM2 : public BaseStateLSA2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_QUITTIERTWSZUVIELAUFFBM2_H_ */
