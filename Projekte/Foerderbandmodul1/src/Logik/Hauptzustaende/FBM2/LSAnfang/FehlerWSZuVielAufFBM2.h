/*
 * FehlerWSZuVielAufFBM2.h
 *
 *  Created on: 22.12.2022
 *      Author: tobias
 */

#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_FEHLERWSZUVIELAUFFBM2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_FEHLERWSZUVIELAUFFBM2_H_

#include "BaseStateLSA2.h"
#include "QuittiertWSZuVielAufFBM2.h"
#include "WarteAufFBM2.h"

class FehlerWSZuVielAufFBM2 : public BaseStateLSA2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANG_FEHLERWSZUVIELAUFFBM2_H_ */
