...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANGBISHS_WARTENLSABISHS2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANGBISHS_WARTENLSABISHS2_H_

#include "BaseStateLSAbisHS2.h"
#include "FehlerWsZuVielLSAbisHS2.h"
#include "WsAufWegZumHsLSAbisHS2.h"

class WartenLSAbisHS2: public BaseStateLSAbisHS2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_LSANFANGBISHS_WARTENLSABISHS2_H_ */
