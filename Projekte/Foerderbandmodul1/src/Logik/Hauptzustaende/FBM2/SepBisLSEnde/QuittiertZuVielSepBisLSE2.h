...
#ifndef LOGIK_HAUPTZUSTAENDE_FBM2_SEPBISLSENDE_QUITTIERTZUVIELSEPBISLSE2_H_
#define LOGIK_HAUPTZUSTAENDE_FBM2_SEPBISLSENDE_QUITTIERTZUVIELSEPBISLSE2_H_

#include "BaseStateSepBisLSE2.h"
#include "WarteSepBisLSE2.h"

class QuittiertZuVielSepBisLSE2 : public BaseStateSepBisLSE2 {
public:
	void entry() override;
	void exit() override;
...
#endif /* LOGIK_HAUPTZUSTAENDE_FBM2_SEPBISLSENDE_QUITTIERTZUVIELSEPBISLSE2_H_ */
